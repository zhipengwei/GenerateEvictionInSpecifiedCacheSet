...
main(int argc,char ** argv)
{
    ...
    command = CMD_STOP_TRACE;
//    ch = *(char *)(config_space_base + 128*command);
//    ch = *(char *)(config_space_base + 128*command);
//    ch = *(char *)(config_space_base + 128*command);
//    ch = *(char *)(config_space_base + 128*command);
//    ch = *(char *)(config_space_base + 128*command);
//    ch = *(char *)(config_space_base + 128*command);
//    ch = *(char *)(config_space_base + 128*command);
////the following code is used to send signal the board plugged into the other DIMM
//    ch = *(char *)(config_space_base + 64 + 128*command);
//    ch = *(char *)(config_space_base + 64 + 128*command);
//    ch = *(char *)(config_space_base + 64 + 128*command);
//    ch = *(char *)(config_space_base + 64 + 128*command);
//    ch = *(char *)(config_space_base + 64 + 128*command);
//    ch = *(char *)(config_space_base + 64 + 128*command);
    ...
    ch = *(char *)(config_space_base + 128*command);
    ch = *(char *)(config_space_base + 128*command);    
    printf("Stop HMTT Trace success!\n");
